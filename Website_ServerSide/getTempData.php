...
$link=Connection();
$result = mysqli_query($link, "SELECT time, tempOutside, tempInside, tempSoil FROM `Microfarm0Climate` ORDER BY `time` DESC");    
	...
	array('id' => "", 'label' => 'tempSoil', 'pattern' => "", 'type' => 'number')
    );
    $rows = array();
